            ...
            <div className="max-width-[550px ] h-[600px] mx-auto bg-black/75 text-white">
              <div className="max-w-[320px] mx-auto py-16">
                ...
                <form onSubmit={handlesubmit} className="w-full flex flex-col py-4">
                  ...
                  <p className="py-4 "><span className="text-gray-600 font-bold mr-2">Already Subsscribed to Netflix?</span><Link to="/login"><span className="text-xl hover:bg-gray-500 px-1 py-1 rounded">Sign In</span></Link></p>
                </form>
              </div>
            </div>
          </div>
